...
const uploadPhotoController = async (req: Request, res: Response) => {
  try {
    ...
    }); // kullanıcının veri tabanındaki users adlı collection içinden bulunuyor id değeri ile ve o kullanıcının profilePictureUrl e güncelleme yapılarak eklediği fotoğrafın cloudinary adresi geliyor
