...
const JWT_SECRET: string | undefined  = process.env.JWT_SECRET // kullanıcının oluşturduğu tokenin imzalanması için kullanılacak
 ...
 export const generateToken = (id:any) => { // token üretemesi için fonksiyondır parametre olarak girilen user  değerine özellik olarak id değeri içierdiğini ve onunda string tipinde olduğunu belirtiyoruz
